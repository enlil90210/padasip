...
class FilterRLS(AdaptiveFilter):
    ...
    * `mu` : forgetting factors (np array). It is introduced to give exponentially
      less weight to older error samples. Each component is usually chosen
      close to 1.
    ...
    * `w` : initial weights of filter. Possible values are:
    ...
    def __init__(self, n, mu=0.99, eps=0.1, w="random"):
        ...
        self.mu = self.check_array_param(mu, 0, 1, "mu")
